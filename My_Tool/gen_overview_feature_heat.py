...
class overview_layer(Image_Drawer):
    def __init__(self,layer_name,super_layer,layer_idx,layer_shape,sub_direction,sub_interval,sub_x_bias,sub_y_bias):
        ...
        self.parent_dir = "visualization_graphs/features_heat_analyse/"
...
parent_dir = "visualization_graphs/features_heat_analyse/"
...
l1.draw(bg_img)
bg_img.save("overview_of_feature_heat_{0}.png".format(l1.image_index))
